...
export default class App extends React.Component {
	...
	UNSAFE_componentWillMount() {
        ...
        console.log("play ground MOUSE: ", this.state.mouse)
			},
	...
	_onGLContextCreate = async (gl) => {
		...
		this.state.camera.position.set(0, 0, 1.0).multiplyScalar(20);
    ...
    scene.traverse((child) => {
	  ...
	  this.state.camera.updateMatrixWorld();

			raycaster.setFromCamera(this.state.mouse, this.state.camera);
